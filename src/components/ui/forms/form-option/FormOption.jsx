		...
		<>
			...
			<ul className="flex items-center gap-1" role="tablist" ref={wrapperRef}>
				<li className="" role="presentation">
					...
					>
						<span className="order-2 hidden sm:block dark:text-neutral-50">Телефон</span>
						<span className="relative">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="-mb-1 h-[28px] w-[28px] dark:text-neutral-50"
								fill="none"
								viewBox="0 0 30 30"
								stroke="currentColor"
								strokeWidth="1.5"
							...
							>
								<title id="title-77asp">Icon phone</title>
				...
				<li role="presentation">
					...
					>
						<span className="order-2 hidden sm:block dark:text-neutral-50">Whatsapp</span>
						<span className="relative">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="-mb-1 h-[28px] w-[28px] dark:text-neutral-50"
				...
				<li className="" role="presentation">
					...
					>
						<span className="order-2 hidden sm:block dark:text-neutral-50">Telegram</span>
						<span className="relative">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="mb-1 h-[28px] w-[28px] dark:text-neutral-50"
				...
				>
					<p>
						<div className="relative my-2 flex flex-col lg:flex-row">
							...
							<label
								for="id-01"
								className="absolute -top-2 left-2 z-[1] cursor-text px-2 text-xs text-slate-400 caret-pink-500 transition-all before:absolute before:left-0 before:top-0 before:z-[-1] before:block before:h-full before:w-full before:bg-white before:transition-all peer-placeholder-shown:top-2.5 peer-placeholder-shown:text-sm peer-autofill:-top-2 peer-required:after:text-pink-500 peer-required:after:content-['\\\\00a0*'] peer-invalid:text-pink-500 peer-focus:-top-2 peer-focus:cursor-default peer-focus:text-xs peer-focus:text-emerald-500 peer-invalid:peer-focus:text-pink-500 peer-disabled:cursor-not-allowed peer-disabled:text-emerald-400 peer-disabled:before:bg-transparent"
							>
								Телефон
							</label>
							<button className="mt-2 inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded border border-emerald-500 px-5 text-sm font-medium tracking-wide text-emerald-500 transition duration-300 hover:border-emerald-600 hover:text-emerald-600 focus:border-emerald-700 focus:text-emerald-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-emerald-300 disabled:text-emerald-300 disabled:shadow-none md:mt-0 lg:ml-2 lg:mt-0 lg:py-2">
