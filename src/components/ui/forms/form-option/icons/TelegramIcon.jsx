...
export default function TelegramIcon({ className = "h-[28px] w-[28px]" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`mb-1 dark:text-neutral-50 ${className}`}
      fill="none"
      stroke="currentColor"
      strokeWidth="3"
      viewBox="0 0 44 44"
      aria-labelledby="telegram-icon-title telegram-icon-desc"
    >
      <title id="telegram-icon-title">Icon Telegram</title>
      <desc id="telegram-icon-desc">Telegram</desc>
