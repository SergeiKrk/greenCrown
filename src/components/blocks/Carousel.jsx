	...
	return (
		<>
			...
			<div className="glide-08 relative w-full">
				{/*    <!-- Slides --> */}
				<div
					className="overflow-hidden rounded bg-white text-center text-slate-500 shadow-2xl shadow-slate-200"
					data-glide-el="track"
				>
									...
									<div className="relative p-6">
										<figure className="relative z-10">
											<blockquote className="p-6 text-lg leading-loose lg:text-xl">
												<p>
													Wind-ui is probably one of the best libraries I've come across. Good
													looking, easy to use and above all super accessible. If you haven't tried
													it yet just do so!
												</p>
											</blockquote>
											<figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
												...
												<div className="flex items-center gap-4 pt-4 text-left text-sm text-emerald-500">
													<img
								...
								<div className="overflow-hidden">
									<div className="relative p-6">
										<figure className="relative z-10">
											<blockquote className="p-6 text-lg leading-loose lg:text-xl">
												<p>
													Wind-ui components come with proper attributes to ensure full
													accessibility with the WAI-ARIA standards. That's just awesome for a free
													ui library.
												</p>
											</blockquote>
											<figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
								...
								<div className="overflow-hidden">
									<div className="relative p-6">
										<figure className="relative z-10">
											<blockquote className="p-6 text-lg leading-loose lg:text-xl">
												<p>
													You can easily communicate with Wind-ui's team for support through their
													discord channel. They are responsive and ultra helpful guys!
												</p>
											</blockquote>
											<figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
												<span
												...
												<div className="flex items-center gap-4 pt-4 text-left text-sm text-emerald-500">
													...
													/>
													<div className="flex flex-col gap-1">
														<span className="font-bold uppercase">Arnold Jones</span>
														<cite className="not-italic">
